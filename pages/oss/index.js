    ...
    return (
      <Page>
        <Head>
          ...
          <meta content={"Brian Lovin · Open Source™"} name="og:title" key="og:title" />
          <meta content={"What I’m working on"} name="og:description" key="og:description" />
          <meta content={"Brian Lovin · Open Source™"} name="twitter:title" key="og:image" />
        </Head>
