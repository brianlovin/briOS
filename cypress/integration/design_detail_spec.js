...
describe('Design Detail Post', () => {
  ...
  it('should render share links', () => {
    cy.get(`[href="https://www.facebook.com/sharer/sharer.php?u=https://brianlovin.com/design-details/${slug}"]`)
      .should('be.visible')

    cy.get(`[href="https://twitter.com/share?text=Design Details: Instagram by @brian_lovin&url=https://brianlovin.com/design-details/${slug}"]`)
      .should('be.visible')
  ...
  it('should render podcast player', () => {
    ...
    cy
      .get(`[href="https://spec.fm/podcasts/design-details"]`)
      .should('be.visible')

    cy.get('[data-cy="episode-play-button"]')
      .should('be.visible');
  })
