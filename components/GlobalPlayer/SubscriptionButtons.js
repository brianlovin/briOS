      ...
      <React.Fragment>
        {
          ...
          <a href={podcast.iTunesUrl} target={"_blank"} rel={"noopener noreferrer"}>
            <SubscriptionAvatar src={'/static/img/subscription_icons/podcasts.png'} alt={'Apple Podcasts'} />
          </a>
        }

        {
          ...
          <a href={podcast.overcastUrl} target={"_blank"} rel={"noopener noreferrer"}>
            <SubscriptionAvatar src={'/static/img/subscription_icons/overcast.png'} alt={'Overcast'} />
          </a>
        }

        {
          ...
          <a href={podcast.pocketCastsUrl} target={"_blank"} rel={"noopener noreferrer"}>
            <SubscriptionAvatar src={'/static/img/subscription_icons/pocketcasts.png'} alt={'Pocketcasts'} />
          </a>
        }

        {
          ...
          <a href={podcast.googlePodcastsUrl} target={"_blank"} rel={"noopener noreferrer"}>
            <SubscriptionAvatar src={'/static/img/subscription_icons/google-podcasts.png'} alt={'Google Podcasts'} />
          </a>
        }

        {
          ...
          <a href={podcast.castroUrl} target={"_blank"} rel={"noopener noreferrer"}>
            <SubscriptionAvatar src={'/static/img/subscription_icons/castro.png'} alt={'Castro'} />
          </a>
        }

        {
          ...
          <a href={podcast.breakerUrl} target={"_blank"} rel={"noopener noreferrer"}>
            <SubscriptionAvatar src={'/static/img/subscription_icons/breaker.png'} alt={'Breakrer'} />
          </a>
        }

        {
          ...
          <a href={podcast.rssFeedUrl} target={"_blank"} rel={"noopener noreferrer"}>
            <SubscriptionAvatar src={'/static/img/subscription_icons/rss.png'} alt={'RSS Feed'} />
          </a>
        }
      </React.Fragment>
    )
