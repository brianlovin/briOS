...
import { AmaPage, useAmaQuestions } from "@/lib/ama";
import { cn } from "@/lib/utils";

interface AMAListClientProps {
  initialData?: AmaPage[];
}

export function AMAListClient({ initialData }: AMAListClientProps) {
