...
interface EpisodeListClientProps {
  initialData?: DesignDetailsEpisodePage[];
}

export function EpisodeListClient({ initialData }: EpisodeListClientProps) {
  ...
  const {
    ...
    isLoading,
    isLoadingMore,
  } = useDesignDetailsEpisodes(initialData);
