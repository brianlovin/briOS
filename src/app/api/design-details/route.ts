import { getDesignDetailsEpisodesPaginated } from "@/db/queries/design-details";
...
export async function GET(request: Request) {
  try {
    ...
    const { items, nextCursor } = await getDesignDetailsEpisodesPaginated(String(cursor), limit);
