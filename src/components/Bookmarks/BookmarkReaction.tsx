...
export default function BookmarkReaction(props: Props) {
  ...
  return (
    <button className="flex space-x-1.5 items-center" onClick={handleReaction}>
      <svg
      ...
      >
        ...
        <path
          ...
          className={`fill-current ${
            bookmark.reactions > 0 ? 'text-red-500' : 'text-quaternary'
          }`}
      ...
      <span className="text-sm text-tertiary">
        {bookmark.reactions.toLocaleString()}
      </span>
    </button>
  )
}
