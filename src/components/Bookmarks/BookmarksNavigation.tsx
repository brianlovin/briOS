...
export default function BookmarksNavigation() {
  ...
  return (
    <div className="flex items-center -ml-4 -mr-10 overflow-x-auto border-b border-gray-300 tabbed-navigation md:-ml-0 md:-mr-0 flex-nowrap dark:border-gray-700">
      <Link href="/bookmarks">
        <a
          className={`tab ${
        ...
        >
          <span className="flex items-center px-5 py-5 space-x-2">
            <Bookmark size={16} />
            <span>All</span>
          </span>
        </a>
