  ...
  return (
    <Page>
      ...
      <CenteredColumn>
        ...
        <div className="p-8 mt-16 -mx-8 space-y-4 bg-yellow-400 border-t border-b border-yellow-300 border-dashed dark:bg-opacity-10 bg-opacity-5 dark:border-gray-800">
