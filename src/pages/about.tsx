              ...
              <div className="space-y-6">
                <div className="space-y-1">
                  ...
                  <p className="text-tertiary">
                    I caught up with Jonny from Progression to talk about the
                    rise of the senior IC, career development for designers,
                    building and exiting a startup, the importance of job
