...
function Home(props: Props) {
  ...
  return (
    <Page>
      <SectionHeading>
        <H1>Brian Lovin</H1>
        <LargeSubheading>I'm a product designer, podcaster, and writer, living in San Francisco. I'm currently building native mobile apps at GitHub.</LargeSubheading>
