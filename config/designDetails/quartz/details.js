...
export default [
  ...
  },
  {
    ...
    title: "Speed reading",
    media: ["https://player.vimeo.com/external/157882209.hd.mp4?s=60d0e2c468ed0e70e72ed3d86a50a1aca8746a41&profile_id=167"]
  },
  {
    description: "Here’s the other weird thing about Quartz: you run out of stories. My mental model was that I could go on forever, slowly digging through the archives of time to older stories. It turns out that Quartz only surfaces the most timely news, which means that you will, in fact, run out of articles. The way Quartz handles this is amazing – a playful bit of copy, a GIF, and naturally, an inline ad.\r\n\r\nOf course the ads are going to be here, and Quartz could have been much more aggressive with their display. But by keeping the format as part of my conversation the banner feels natural and inviting. Ads like this are the future (although in time they will become more personalized): native, inline and unobtrusive.",
    title: "Ads and delight",
    media: ["https://player.vimeo.com/external/157882211.hd.mp4?s=01a40b5e2fb459e00bb0c0d2a9175a35b4758cea&profile_id=113"]
  },
  {
    description: "When I ran out of stories I closed the app then immediately re-opened it to see if it would try and repopulate anything or surface another method of engagement. It turns out Quartz has implemented some amazing product thinking to produce this empty state interaction pattern: when there are no more stories, the app explains why and offers a small bit of fun activity to help avoid disappointment or frustration. I’m sure that this also builds a strong emotional connection to the app, because there’s never any doubt that you’ll at least get something fun whenever you open the product.",
    title: "Quiz",
    media: ["https://player.vimeo.com/external/157882210.hd.mp4?s=031a50ac854f8853d012d6fa232dc87eafd61b60&profile_id=167"]
  },
  {
    description: "And back we go to our out-of-news state. The copywriting here is phenomenal. It’s not too pushy, not overly friendly; it’s professional and concise, clear and obvious. Well done to the team that pulled this together.",
    title: "Return to empty",
    media: ["https://player.vimeo.com/external/157882213.hd.mp4?s=5be44e6c3faf2d291bc1ec3741e659b21a3855c4&profile_id=113"]
  }
]