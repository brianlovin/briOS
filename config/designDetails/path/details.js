...
export default [
  {
    description: "Path wastes no time delighting new users with their popup design language. The light bouncing in and fading out makes these modals feel so alive. Just wonderful – we’ll see a few more instances of this style being used in all parts of the app. +1 for consistency!",
    title: "Login modal",
    media: ["https://player.vimeo.com/external/157933950.sd.mp4?s=6af59339884ee4c64a78a3771e8dab04433f3bd2&profile_id=165"]
  },
    {
    description: "This onboarding flow is so slick! No extra fuss or unneeded messaging – just a few simple steps to get started, the modal fades away, then users are greeted with this simple interface and tooltip on the main share button. You can tell how much time the designers put into the small details here – especially the language on the tooltip.\r\n\r\nCreate a moment – this introduces new users to this process of sharing moments, not fluff. This isn’t where you share your latest score on Candy Crush, no – it’s a place to share moments with your friends. I like that.",
    title: "Onboarding",
    media: ["https://player.vimeo.com/external/157933951.sd.mp4?s=710c7f333118aced7e1eea70d4439a7ee96b4e92&profile_id=165"]
  },
  {
